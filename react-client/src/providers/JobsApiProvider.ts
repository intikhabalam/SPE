...
import { IJob, IJobClientCreateRequest, IJobPostingDoc, IJobUpdateRequest } from '../../../common/schemas/JobSchemas';
...
export class JobsApiProvider {
    ...
    public async getPostingDoc(jobId: string): Promise<IJobPostingDoc> {
        ...
        return await this._send(`/jobs/${jobId}/posting`, request) as IJobPostingDoc;
    }
    ...
    public async createPostingDoc(jobId: string): Promise<IJobPostingDoc> {
        ...
        return await this._send(`/jobs/${jobId}/posting/create`, request) as IJobPostingDoc;
    }
    ...
    public async enableProcessing(id: string): Promise<IJob> {
        ...
        return await this._send(`/enableContainerProcessing?containerId=${id}`, request) as IJob;
    }
    ...
    public async disableProcessing(id: string): Promise<IJob> {
        ...
        return await this._send(`/disableContainerProcessing?containerId=${id}`, request) as IJob;
    }
